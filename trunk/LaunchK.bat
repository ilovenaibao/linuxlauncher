...
set _iso_name=kubuntu-8.10-desktop-i386.iso
set _iso_url=ftp://ftp.rediris.es/sites/releases.ubuntu.com/releases/kubuntu/intrepid/kubuntu-8.10-desktop-i386.iso
