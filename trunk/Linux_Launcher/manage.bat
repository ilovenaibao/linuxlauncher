@echo off
title Linux Launcher 1.0.3 BETA - Opciones - Administrar HDD
cls
...
start .\qemu\qemu -L .\qemu -kernel-kqemu -std-vga -localtime -soundhw all -m 256 -hda hda.img -cdrom gparted-live-0.4.5-2.iso -boot d
option.bat