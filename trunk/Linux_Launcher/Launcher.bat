@echo off
title Linux Launcher 1.0.3 BETA
cls
goto check
:check
...
set _iso_name=geexbox-1.2.1.en.i386.glibc.iso
set _iso_url=http://www1.geexbox.org/releases/1.2.2/geexbox-1.2.2-en.i386.glibc.iso
LaunchLIN.bat
:su
cls
