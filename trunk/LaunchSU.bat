...
set _iso_name=Super_Ubuntu_2008.11.iso
set _iso_url=http://linuxfreedom.com/superubuntu/Super Ubuntu 2008.11.iso
...
echo.
.\wget\wget "%_iso_url%"
ren Super Ubuntu 2008.11.iso Super_Ubuntu_2008.11.iso
if exist "%_iso_name%" goto open else (
goto autorun
)
:autoexit
...
echo.
echo.
echo Se ejecutará la distribucion %_distro_name% desde tu PC usando QEMU.
